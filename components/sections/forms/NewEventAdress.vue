<template>
  <form class="mb-3">
    <h1 class="text-center mt-3 animated slideInDown">Agrega la dirección del evento</h1>
    ...
    <div class="row m-0 mt-3">
      <div class="col-md-4">
        <select v-model="adressObject.state" class="custom-select" id="inputGroupSelect01">
          <option selected>Estado ...</option>
          <option-input v-for="estado in estados" :key="estado.id" v-bind="estado" />
        </select>
      </div>
      <div class="col-md-2">
        <input type="text" class="form-control" placeholder="Colonia" v-model="adressObject.town" />
      </div>
      <div class="col-md-3">
        <input
          type="text"

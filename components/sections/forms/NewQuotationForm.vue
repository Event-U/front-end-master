      ...
      <div class="input-group-prepend">
        ...
        <span
          v-if="
					...
					"
          class="invalid-feedback animated fadeInLeft faster"
        >El precio no puede ser menor a $50 para tu cotización</span>
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <span
        v-if="
				...
				"
        class="invalid-feedback animated fadeInLeft faster"
      >La imagen de tu servicio tiene que ser un formato válido de imagen</span>
      <span
        v-if="

<template>
  <form class="m-3 text-center">
    ...
    <div class="form-group">
      ...
      <input class="form-control" id="newServiceName" aria-describedby="emailHelp" v-model="name" />
      <small id="emailHelp" class="form-text text-muted">Recuerda ser lo más conciso posible.</small>
    </div>
    <div class="form-group">
      <select v-model="category" class="custom-select" id="inputGroupSelect0">
        <option selected>Elige una categoría...</option>
        <option-input v-for="option in categories" :key="option._id" v-bind="option" />
      </select>
    </div>
    <div class="form-group">
      <select v-model="measurementUnit" class="custom-select" id="inputGroupSelect01">
    ...
    <div class="form-group">
      ...
      <div class="input-group-prepend">
        ...
        <input class="form-control" aria-describedby="emailHelp" v-model="unitPrice" />
      </div>
    </div>
    <div class="form-group">
      <label for="newServiceName">Url de tu imagen</label>
      <input class="form-control" aria-describedby="emailHelp" v-model="image" />
    </div>
    <div class="form-group">
      <label for="description">Descripción</label>
      <textarea type="password" class="form-control" id="description" v-model="description" />
    </div>
    <button type="submit" class="btn btn-primary" @click.prevent="postNewService">Subir servicio</button>
  </form>
</template>

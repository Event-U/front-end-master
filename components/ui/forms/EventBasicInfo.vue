  ...
  <div class="mt-3 my-element">
    ...
    <div class="form-group animated fadeInDown">
      <div class="form-group col-md-5">
        ...
        >El nombre debe contener al menos {{$v.name.$params.minLength.min}} caracteres.</div>
        <div
          v-if="$v.name.$error&&!$v.name.required"
          class="invalid-feedback animated fadeInLeft faster"
        >El nombre de tu evento es requerido 😱</div>
      </div>
      <div class="form-group col-md-5 animated fadeInUp delay-1s">
        <label for="exampleFormControlTextarea1">Descripción de tu evento</label>
        <textarea
          @input="setActiveEvent"
          v-model="description"
          :class="{
        ...
        <div
          ...
          class="invalid-feedback animated fadeInLeft faster"
        >La descripción debe contener al menos {{$v.description.$params.minLength.min}} caracteres.</div>
        <div
          v-if="$v.description.$invalid&&!$v.description.required"
          class="invalid-feedback animated fadeInLeft faster"
        >La descripción de tu evento es requerida 😱</div>
      </div>
    </div>
  </div>
</template>

<template>
  <div class="mt-3  my-element">
    ...
    <div class="form-group animated fadeInDown">
        ...
        >
          El nombre debe contener al menos {{$v.name.$params.minLength.min}} caracteres.
        </div>
        <div 
        ...
        <div class="form-group col-md-5 animated fadeInUp delay-1s">
            <label for="exampleFormControlTextarea1">
                ...
                class="invalid-feedback animated fadeInLeft faster"
                >
                La descripción debe contener al menos {{$v.description.$params.minLength.min}} caracteres.
                </div>
                <div 

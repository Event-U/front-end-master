      ...
      >
        <div class="modal-dialog" role="document">
          <div class="modal-content m-lg-3 p-3">
            <new-service-form />
            <button type="button" class="btn btn-border mb-3" data-dismiss="modal">Cerrar formulario</button>
          </div>
        </div>
      </div>
    </div>
    <div class="service-row row d-flex align-items-stretch">
      <div class="col-md-3 col-12 mt-3" v-for="service in services" :key="service._id">

			...
			<div class="container container-one">
				...
				<div class="row bg-one">
					<div class="col-md-6 col-sm-12">
						...
						<div class="btn-media">
							<nuxt-link to="/app/organizador/mis-eventos">
								<button type="button" class="btn btn-outline-dark btn-one">
									Comenzar ahora
								</button>
							</nuxt-link>
						</div>
					...
					<div class="col-md-6 col-sm-12 view-one">
						<img
							src="../assets/landing/images/AppleiPhone.png"
							class="img-iphone"
							alt=""
						/>
					</div>
				...
				<div class="container text-center">
					<div class="row" style="justify-content: center; margin-bottom: 40px">
						<div class="img-square">
							<img
								src="../assets/landing/icons/Box.png"
			...
			<div class="container features">
				<div class="row">
					<div class="col-sm-4 card-features">
						<div class="circle">
							<img
								src="../assets/landing/icons/teamIcon.png"
								class="img-responsive"
								alt=""
							/>
						</div>
					...
					<div class="col-sm-4 card-features">
						<div class="circle">
							<img
								src="../assets/landing/icons/opinions.png"
								class="img-responsive"
								alt=""
							/>
						</div>
					...
					<div class="col-sm-4 card-features">
						<div class="circle">
							<img
								src="../assets/landing/icons/statistics.png"
			...
			<div class="container container-four">
				<div class="row img-r" style="display: flex; align-items: center;">
					<div class="col-sm-6 iphone-letf">
						<div>
							<img
								src="../assets/landing/images/iPhone Left.png"
								alt=""
								class="img-iphone-left"
							/>
						</div>
					</div>
					<div class="col-sm-6 card-four">
						<img
							src="../assets/landing/icons/icon-four.png"
							alt=""
							class="img-four"
						/>
						<div style="margin-top: 40px;">
							<h1 class="title">
								Con la <span class="title futura-medium-bt">confianza</span>
								<br />
								de las reseñas
							</h1>
							<p style="text-align: justify;">
								Accede a la reseña de usuarios cúmo tú que ya contrataron <br />
								los servicios o que ya pasaron con estos datos
							</p>
						</div>
					</div>
				</div>
			...
			<div class="container container-five">
				<div class="row img-r">
					<div class="col-sm-6 card-five">
						<img
							src="../assets/landing/icons/icon-five.png"
							alt=""
							class="img-five"
						/>
						<div style="margin-top: 40px;">
							<h1 class="title">
								...
								<span class="futura-medium-bt card-five-span"
									>al alcance de tu mano</span
								>
							</h1>
							<p
								class="text-secondary card-five-16"
								style="text-align: justify;"
							>
								Con la inteligencia de datos desarrollada<br />
								en Event-u podrás tener datos a la mano<br />
			...
			<div class="bg-six">
				<div class="container text-center">
					...
					<div class="start">
						...
						<h4 class="fonts-white">
							Confianza de inversionistas certificados
						</h4>
			...
			<div class="container">
				<div class="row row-footer">
					<div class="col-sm-12 footer">
						<h1>
							Crea tu cuenta <br />
							en <span class="futura-medium-bt">menos de dos minutos</span>
							<br />

	...
	<div>
		...
		<section class="section-five">
			<div class="container container-five">
				<div class="row img-r">
					<div
						class="col-sm-6 card-five align-content-center justify-content-center"
					>
						<img
						...
						<div style="margin-top: 40px;">
							...
							>
								...
								<br />en Event-u podrás tener datos a la mano <br />facilita la
								toma de decisiones
							</p>
						</div>
					</div>

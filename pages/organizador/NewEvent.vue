...
export default {
	...
	components: {
		NewNeedForm: () =>
			import(
				/* webpackChunkName: "NewNeedForm" */ '@/components/sections/NewNeedForm.vue'
			),
		EventBasicInfo: () =>
			import(
		...
		EventCard: () =>
			import(
				/* webpackChunkName: "EventCard" */ '@/components/ui/EventCard.vue'
			),
		EventNeed: () =>
			import(
				/* webpackChunkName: "EventNeed" */ '@/components/ui/EventNeed.vue'
			),
		NewEventAdress: () =>
			import(
				/* webpackChunkName: "NewEventAdress" */ '@/components/sections/NewEventAdress.vue'
			),
	},

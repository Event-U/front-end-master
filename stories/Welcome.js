...
export default {
    ...
    template: `
    <div :style="main">
      <h1>Bienvenido a Event-U</h1>
      <p>
        Somos el proyecto que nació de las necesidades de un mercado potencial 
        para convertirse en la siguiente revolución de eventos
      </p>
      <p>
